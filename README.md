...
- Использована событийно-ориентированная архитектура. Доменные события для взаимодействия агрегатов Order и Courier. 
Интеграционные события отправляются наружу, соблюдая контракт protobuf стороннего сервиса.
